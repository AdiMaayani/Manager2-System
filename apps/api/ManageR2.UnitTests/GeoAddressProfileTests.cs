...
public class AddressIdentityComparerTests
{
    ...
    [Fact]
    public void HasStableIdentityChanged_UsesFormattedAddressFallbackOnly()
    {
        var previous = new AddressProfile
        {
            FormattedAddress = "Same formatted",
            City = "Old city",
            Postcode = "11111"
        };
        var next = new AddressProfile
        {
            FormattedAddress = "Same formatted",
            City = "New city",
            Postcode = "22222"
    ...
    [Fact]
    public void HasStableIdentityChanged_ReturnsTrueWhenFormattedAddressChanges()
    {
        var previous = new AddressProfile { FormattedAddress = "Old formatted" };
        var next = new AddressProfile { FormattedAddress = "New formatted" };
