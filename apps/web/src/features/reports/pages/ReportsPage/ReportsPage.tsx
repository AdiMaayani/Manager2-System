...
const REPORT_TARGET_SELECT_LABELS: Record<ReportTypeValue, string> = {
  regular: 'בחר משימה כללית לדיווח',
  project: 'בחר משימת פרויקט לדיווח',
  service_call: 'בחר קריאת שירות לדיווח',
};
                ...
                <div className="reportsPage__targetSelection">
                  {isQuickReportPrefill && selectedTarget ? (
                    <div className="reportsPage__quickTarget">
                      <p className="reportsPage__quickTargetLabel">יעד הדיווח</p>
                      <p className="reportsPage__quickTargetValue">
                        {formatReportTargetLabel(selectedTarget)}
                      </p>
                      <Button
                        type="button"
                        variant="ghost"
                    ...
                    <>
                      ...
                      {targetsForSelectedType.length === 0 ? (
                        ...
                        <div className="reportsPage__targetSelect">
                          ...
                          />
                          <Select
                            label={REPORT_TARGET_SELECT_LABELS[form.reportTargetType]}
                            value={form.workItemId}
                            onChange={(event) => handleTargetChange(event.target.value)}
                            required
                          >
                            <option value="">{REPORT_TARGET_SELECT_LABELS[form.reportTargetType]}</option>
