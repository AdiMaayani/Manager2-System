...
const SAFETY_RULES = [
  'רק עובד לא פעיל מוחרג מרשימת המועמדים; כל עובד פעיל נכלל ונשאר ניתן לבחירה.',
  'כל עובד שנכנס לרשימת המועמדים מדורג וניתן לבחירה; הציון הוא כלי תומך החלטה.',
  'סטטוס "ניתן לשיבוץ", פער מקצועי, כישור חסר או חוסר זמינות משפיעים על הציון וההסבר בלבד, ואינם פוסלים עובד פעיל.',
    ...
    <div className="smartPolicySettings">
      ...
      <section className="smartPolicySettings__group smartPolicySettings__preview">
        <div className="smartPolicySettings__groupHeader">
          ...
          <p>התצוגה המקדימה מחשבת את הציון לפי המשקלים שבחרת. הפעולה אינה שומרת מדיניות ואינה משבצת עובד.</p>
        </div>
